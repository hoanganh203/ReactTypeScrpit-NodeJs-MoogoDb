...
import { getCategory, productAdd } from "../api/product";
import { CategoryForm, ICategory, ProductAddForm, productAddSchema } from "../models";
...
const ProductAdd = () => {
    const { register, handleSubmit, formState: { errors } } = useForm<ProductAddForm>({
